...
export class SjfComponent implements OnInit, OnDestroy {
  ...
  onParametersChanged(lambda: number, d1: number, d2: number): void {
    ...
    const E3 = 1 / d1;
    // tslint:disable-next-line:max-line-length
    const pvg = (E1 * E2 * (2 * E1 + E2)) / (2 * E1 * E1 * E1 + E1 * E1 * E3 + 3 * E1 * E1 * E2 + 2 * E1 * E2 * E3 + E1 * E2 * E2 + E3 * E2 * E2);
    const pgg = (E2 * E3) / (E1 * E3 + E2 * E3 + 2 * E1 * E1 + E1 * E2);
    const pgv = (E1 * E2 * E3) / (2 * E1 * E1 * E1 + E1 * E1 * E3 + 3 * E1 * E1 * E2 + 2 * E1 * E2 * E3 + E1 * E2 * E2 + E3 * E2 * E2);
    // tslint:disable-next-line:max-line-length
    const pwv = (E1 * E1 * (2 * E1 + E2 + E3)) / (2 * E1 * E1 * E1 + E1 * E1 * E3 + 3 * E1 * E1 * E2 + 2 * E1 * E2 * E3 + E1 * E2 * E2 + E3 * E2 * E2);
    ...
    this.dataSource[1].d1 = pwv + pvg;
    this.dataSource[1].d2 = pwv + pgv;
